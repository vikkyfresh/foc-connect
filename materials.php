...
$courses_query = "SELECT c.id, c.course_code, c.course_name FROM courses c
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .course-btn { background: #F5F7F6; border: 1px solid #E8EDEC; padding: 10px 20px; border-radius: 40px; cursor: pointer; text-decoration: none; color: #1A2E28; transition: 0.2s; }
        ...
        .material-item { display: flex; justify-content: space-between; align-items: center; padding: 16px 20px; border-bottom: 1px solid #E8EDEC; flex-wrap: wrap; gap: 12px; }
            ...
            <div class="course-selector">
                ...
                <div class="course-buttons">
                    <?php if(mysqli_num_rows($courses) > 0): ?>
                        ...
                        <?php endwhile; ?>
                    <?php else: ?>
                        <p style="color: #8A9B97;">No courses enrolled yet. Contact your HOD.</p>
                    <?php endif; ?>
                </div>
            </div>
                ...
                <div class="materials-list">
                    <?php while($material = mysqli_fetch_assoc($materials)): ?>
                        <div class="material-item">
                            ...
                            <button class="course-btn" onclick="alert('Download - File: <?php echo $material['file_name']; ?>')">📥 Download</button>
                        </div>
                    <?php endwhile; ?>
                </div>
